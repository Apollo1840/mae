...
def setup_model(args):
    # arg.model in ["mae_vit_base_patch16", "mae_vit_large_patch16", "mae_vit_huge_patch16"]
...
def main(args):
    ...
    # step 1: get data_load for _train
    # simple augmentation
    dataset_train = build_dataset_pretrain(args.data_path)
